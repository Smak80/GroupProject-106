    ...
    public class Painter
    {
        ...
        public void PaintGraph(double x, double y)
        {
            if (isCorrectInput)
            {
                ...
                k++;
                mainGraphics.FillRectangle(brushR, (int)(X + x * multiplierX), (int)(Y - (y < 0 ? 0 : y * multiplierY)), (int)(step * multiplierX) < 1 ? 1 : (int)(step * multiplierX)+diffX>2?3:7, (int)(Math.Abs(y) * multiplierY));
            }
